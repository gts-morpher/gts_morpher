 ...
 */
package uk.ac.kcl.inf.gts_morpher.formatting2
...
import uk.ac.kcl.inf.gts_morpher.gtsMorpher.UnitCallList
import uk.ac.kcl.inf.gts_morpher.gtsMorpher.UnitParameterList
import uk.ac.kcl.inf.gts_morpher.services.GTSMorpherGrammarAccess
import uk.ac.kcl.inf.gts_morpher.gtsMorpher.GtsMorpherPackage

class GTSMorpherFormatter extends AbstractFormatter2 {
	
	@Inject extension GTSMorpherGrammarAccess
	...
	def dispatch void format(GTSMapping mapping, extension IFormattableDocument document) {
		...
		mapping.regionFor.feature(GtsMorpherPackage.Literals.GTS_SPECIFICATION_MODULE_MEMBER__NAME).surround[oneSpace]
	...
	def dispatch void format(GTSSpecification gts, extension IFormattableDocument document) {
		...
		gts.regionFor.feature(GtsMorpherPackage.Literals.GTS_SPECIFICATION_MODULE_MEMBER__NAME).surround[oneSpace]
	...
	def dispatch void format(GTSLiteral gts, extension IFormattableDocument document) {
		...
		gts.regionFor.feature(GtsMorpherPackage.Literals.GTS_LITERAL__BEHAVIOUR).prepend[oneSpace]
	}
